...
class CompressedDataset(Dataset):
    def __init__(self, df, image_folder, lazy_loading=True):
        """
...
def create_datasets(folder, test_size=0.25, seed=None, lazy_loading=True):
    """
    ...
    return CompressedDataset(df_train, input_folder, lazy_loading), CompressedDataset(df_test, input_folder, lazy_loading)
